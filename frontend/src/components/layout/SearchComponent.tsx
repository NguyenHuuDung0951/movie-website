...
export const SearchComponent = ({ placeholder = "Tìm kiếm phim...", minLength = 2 }: SearchComponentProps) => {
 ...
 <div ref={wrapperRef} className="relative w-full max-w-2xl min-w-0">
  ...
  {open && (
    <div className="absolute left-0 right-0 z-20 mt-2 overflow-hidden rounded-3xl border border-white/10 bg-[#0f1220]/90 p-4 shadow-2xl shadow-black/40 backdrop-blur-xl">
      ...
      <div className="max-h-[500px] overflow-y-auto pr-2" style={{ scrollbarWidth: "thin", msOverflowStyle: "auto" }}>
        {loading ? (
          ...
          results.map((item) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-sm font-semibold text-white">{getTitle(item)}</div>
