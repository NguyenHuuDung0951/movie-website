...
export const EpisodeList = ({ seasons, selectedSeason, onSeasonChange, totalEpisodes }: Props) => {
  // Nếu không có seasons nhưng có totalEpisodes, hiển thị danh sách tập đơn giản
  if (!seasons?.length && totalEpisodes) {
    return (
      <section className="rounded-2xl border border-zinc-800 bg-zinc-950/70 p-4 sm:p-5">
        <h2 className="mb-4 text-lg font-bold text-zinc-100">Danh sách tập</h2>
